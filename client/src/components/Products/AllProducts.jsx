...
const AllProducts = ({ filteredProducts, bredCrumb, checkedItems, setCheckedItems, data, setFilteredData, selectedBrands, setSelectedBrands, setSelectedPriceRange, setFilteredAttr }) => {
    ...
    return (
        <div className='allproducts-main'>
            ...
            <FilteredContext checkedItems={checkedItems} setCheckedItems={setCheckedItems} data={data} setFilteredData={setFilteredData} selectedBrands={selectedBrands} setSelectedBrands={setSelectedBrands} setSelectedPriceRange={setSelectedPriceRange} setFilteredAttr={setFilteredAttr} />
