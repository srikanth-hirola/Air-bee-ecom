    ...
    return (
        <div>
            ...
            <div className='flex justify-between mt-6'>
                ...
                <div>
                    {logoLoading ? <button className='px-4 py-2 rounded' style={{ backgroundColor: styles?.mainColor, color: styles?.fontColor }}>Loading...</button> : <button className='px-4 py-2 rounded' style={{ backgroundColor: styles?.mainColor, color: styles?.fontColor }} onClick={(e) => handleUpdateCategories(e, "CategoriesOne", CategoriesOne, setLogoLoading)}>Update</button>}
                </div>
            </div>
