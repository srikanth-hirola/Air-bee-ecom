...
const DraftKeywords = ({ searchTerms, setSearchTerms, formData, colorInputs }) => {
    ...
    // const handleAdd = (e) => {
    //   e.preventDefault();
    //   const updatedArray = [...searchTerms];
    //   updatedArray.push(term);
