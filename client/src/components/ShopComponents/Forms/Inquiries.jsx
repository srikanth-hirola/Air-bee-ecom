...
const Inquiries = () => {
  ...
  const filteredProducts = productData.filter((item) =>
    item.name.toLowerCase().includes(searchState) || item.email.toLowerCase().includes(searchState) || item.phone.toLowerCase().includes(searchState) || item.item.toLowerCase().includes(searchState)
  );
