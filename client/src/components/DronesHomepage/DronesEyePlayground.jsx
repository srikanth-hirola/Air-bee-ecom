                ...
                <div className='DronesEyePlayground-sub'>
                    ...
                    <div className="col-md-12">
                        <div className='DronesEyePlayground-sub-content1'>
                            ...
                            <p>Dive into our extensive catalog featuring over 1 lakh in-stock parts. Explore 10 comprehensive categories and 100 sub-categories, offering everything from essential components to advanced modules and projects. At Air Bee, we curate a diverse range to fuel your imagination.</p>
                        </div>
                    </div>
                    <div className="col-md-12">
                        <div className='DronesEyePlayground-sub-content1'>
