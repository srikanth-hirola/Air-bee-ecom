                                    ...
                                    <div className="Drones-footer-logo-content">
                                        {footerContent?.logo?.image?.url &&
                                            <div className='Drones-footer-logo-image'>
                                                ...
                                                <LazyLoadImageComponent alt={"logo"} height={"100%"} width={"100%"} img={footerContent?.logo?.image?.url} />
                                            </div>
                                        }
                                                            ...
                                                            <div key={index} className="col-2">
                                                                <Link to={item.url}>
                                                                    <div className='Drones-social-icons-image'>
                                                                        ...
                                                                        <LazyLoadImageComponent alt={"socialIcons"} height={"100%"} width={"100%"} img={item?.image?.url} />
                                                                    </div>
                                                                </Link>
                                                            </div>
                                                        ))} </div>
                                                ...
                                                <div className='col-md-12' key={i}>
                                                    <Link to={item?.url}>
                                                        <div className='DronesFooter-apps-image'>
                                                            ...
                                                            <LazyLoadImageComponent alt={"apps"} height={"100%"} width={"100%"} img={item?.image?.url} />
                                                        </div>
                                                    </Link>
                                                </div>
                                            ))
